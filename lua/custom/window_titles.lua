...
-- Match NvChad's statusline style by linking to StatusLine
local function setup_winbar_highlights()
  -- Link WinBar to StatusLine to match NvChad's statusline style exactly
  -- Then override just the bold attribute for active windows
  -- WinBar: active window bar
  -- WinBarNC: inactive
  vim.cmd([[
